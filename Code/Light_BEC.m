...
nj = 1000000; stepJ = 100000;                                    % times of runs and steps between updates normalized energy 
%% BEC parameters
As = 5.82e-09;
Nbec = 10000;
Rabi = 1000;
...
parfile = '161020_Light_BEC.mat';                                      %!!!Parameters here.
...
%%
gpuDevice(1);
computeBEC('101220_halfLG10_my', parPath, lightPath);
